...
\begin{document}
	...
	\titulo{Galáxias peculiares aneladas no levantamento do S-PLUS} 
	...
	\include{Conteudo/02_Galaxiaspeculiares}
	\include{Conteudo/03_FundamentacaoTeorica}
	\include{Conteudo/04_Metodologia}
	\include{Conteudo/05_AnaliseResultados}
